...
const Cards = () => {
  return (
    <div>
      <div class="contenedorCards grid grid-cols-2 lg:grid-cols-5">
        <div class="card">
          <div class="wrapper">
        ...
        <div class="card">
          <div class="wrapper">
            ...
            <div class="infoProd">
              <p class="nombreProd">
                Nendoroid Fate/Grand Order: Saber/Arthur Pendragon Ascension
              </p>
              <p class="extraInfo">Fecha de salida: 31/03/2021</p>
              <div class="actions">
                <div class="preciosGrupo">
        ...
        <div class="card">
          <div class="wrapper">
            ...
            <div class="infoProd">
              <p class="nombreProd">
                figma Kantai Collection -Kan Colle- Kashima
              </p>
              <p class="extraInfo">Fecha de salida: 31/03/2021</p>
              <div class="actions">
                <div class="preciosGrupo">
